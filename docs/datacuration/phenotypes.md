...
Below is a list of static, meaning precisely identified hard-coded elements (i.e. participants, instruments, and instrument fields) and dynamic elements excluded during the data release process as well as general rules applied to all data:
